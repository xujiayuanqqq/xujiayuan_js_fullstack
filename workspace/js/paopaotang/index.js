...
Player.prototype.die = function() {
    ...
    // for this.partners 4个 dead 游戏结束 我方输， 对方赢
    // this.state = 'dead';
    // if(!this.partners) {
    //     for(let i = 0; i < this.partners.length;i++) {
    //         this.partners[i].lose();
    //         this.partners[i].state = 'dead';
    //     }
    // }
...
// const player3 = new Player('小P');
// const player4 = new Player('小Q');
// player2.lose();

// 上线了， 互成敌人， 匹配到一局去了
// player1.enemy = player2;
// player2.enemy = player1;
// player3.enemy = player4;
// player4.enemy = player3;
